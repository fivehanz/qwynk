...
config :qwynk, QwynkWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: QwynkWeb.ErrorHTML, json: QwynkWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Qwynk.PubSub,
  live_view: [signing_salt: "O1omPSFY"]
...
config :qwynk, Qwynk.Mailer, adapter: Swoosh.Adapters.Local
